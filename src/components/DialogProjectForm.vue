        ...
        <div class="flex flex-col gap-9">
            ...
            <form class="grid grid-cols-1 gap-4 xl:grid-cols-2">
                <div class="flex items-center gap-3 xl:col-span-2">
                    ...
                    <label for="project-continue-participating" class="font-semibold text-sm md:text-base">Continuo
                        participando do
                        projeto</label>
                </div>
                <div class="flex flex-col gap-3">
                    <label for="project-name" class="font-semibold">Nome do projeto</label>
                ...
                <div class="flex flex-col gap-3">
                    <label for="function" class="font-semibold">Função principal</label>
                    <input type="text" name="" id=""
                        class="border border-border bg-transparent w-full rounded-lg px-3 py-2 text-sm h-10 outline-none md:py-6 md:text-base"
                ...
                <div class="flex flex-col gap-3 xl:col-span-2">
                    <label for="description" class="font-semibold">Descriçao</label>
