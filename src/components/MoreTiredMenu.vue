...
<template>
    ...
    <TieredMenu ref="menu" id="overlay_tmenu" :model="items" popup
        ...
        <template #item="{ item, props }">
            <a v-ripple class="flex items-center p-2" v-bind="props"
                @click="item.label == 'Editar' ? isModalOpen = true : isDeleteModalOpen = true">
    ...
    <Dialog v-model:visible="isDeleteModalOpen" modal header="Deletar projeto"
        ...
        <div class="flex flex-col gap-7 w-full">
            ...
            <div class="flex justify-end gap-2 mt-3">
                ...
                <button type="button" class="px-4 py-2 bg-destructive border border-border rounded-md font-semibold"
